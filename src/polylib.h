 ...
 * polylib.h
 *
 * polylib provides a library of some usefule functions for the  
 * computation of Jacobi polynomials, including the function 
 * value, derivative, Gauss-type quadrature points, integration 
 * weights, etc.
 *
